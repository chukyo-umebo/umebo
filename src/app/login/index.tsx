...
export default function Login() {
    ...
    return (
        <LoginTemplate>
            <View className="flex-1 items-center justify-between pb-24 pt-40">
                <View className="items-center gap-3">
                    <View
                        className="items-center justify-center rounded-[23px] bg-white"
                        style={{
                    ...
                    <View className="items-center">
                        ...
                        <Text className="font-['Noto_Sans_JP:Black'] text-[3rem] font-black text-[#e50120]">
                            中京UMEBO
                            <Text className="font-['Noto_Sans_JP:Black'] text-[1.8rem] font-black text-[#1b1a19]">
                                へ！
                            </Text>
