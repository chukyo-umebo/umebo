        ...
        <LoginTemplate>
            <View className="flex-1">
                ...
                >
                    ...
                    />
                    <NotificationPage width={width} scrollToNext={scrollToNext} />
                    <SetupCompletePage
                        width={width}
...
function CampusSelectionPage({
    ...
    width: number;
    selectedCampus: "nagoya" | "toyota";
    setSelectedCampus: (campus: "nagoya" | "toyota") => void;
    scrollToNext: () => void;
}) {
    return (
        <View style={{ width }} className="flex-1 justify-between px-7 pt-40">
            <View className="items-start">
                ...
                <Text className="font-['Noto_Sans_JP:Black'] text-[2rem] font-black leading-tight text-[#2e6bff]">
                    キャンパス
                    <Text className="font-['Noto_Sans_JP:Black'] text-[1.5rem] font-black text-[#1b1a19]">に</Text>
                </Text>
                <Text className="font-['Noto_Sans_JP:Black'] text-[1.5rem] font-black leading-tight text-[#1b1a19]">
                    在籍していますか？
                </Text>
            ...
            <View className="pb-24">
                ...
                >
                    ...
                    >
                        <Text className="font-['Noto_Sans_JP:Medium'] text-[1rem] font-medium text-white">次へ</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
...
function NotificationPage({ width, scrollToNext }: { width: number; scrollToNext: () => void }) {
    return (
        <View style={{ width }} className="flex-1 justify-between px-7 pt-40">
            <View className="items-start">
                <Text className="font-['Noto_Sans_JP:Black'] text-[2rem] font-black leading-tight text-[#2e6bff]">
        ...
        <View style={{ width }} className="flex-1 justify-between px-7 pt-40">
            <View className="items-start">
                <Text className="font-['Noto_Sans_JP:Black'] text-[1.5rem] font-black leading-tight text-[#1a1a1c]">
                    セットアップ
                    <Text className="font-['Noto_Sans_JP:Black'] text-[2rem] font-black text-[#2e6bff]">完了！</Text>
                </Text>
                <Text className="mt-4 font-['Noto_Sans_JP:Medium'] text-[0.875rem] font-medium text-[#626160]">
